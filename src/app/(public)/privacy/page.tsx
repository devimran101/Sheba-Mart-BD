...
export const metadata: Metadata = {
  title: 'Privacy Policy | Sheba Mart BD',
  description: 'Learn how Sheba Mart BD collects, uses, and protects your personal information.',
};
...
async function getSettings() {
  try {
    ...
    if (!settings) {
      return {
        brandName: "Sheba Mart BD",
        contact: {
          email: "support@shebamartbd.com"
        }
      };
    }
...
export default async function PrivacyPage() {
  ...
  const contactEmail = settings.contact?.email || "support@shebamartbd.com";
