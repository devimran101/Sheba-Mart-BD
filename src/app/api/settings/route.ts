  ...
  try {
    ...
    if (!settings) {
      return NextResponse.json({
        brandName: process.env.NEXT_PUBLIC_STORE_NAME || "Sheba Mart BD",
        contact: {
        ...
        marqueeText: "Welcome to Sheba Mart BD!",
        metaTitle: process.env.NEXT_PUBLIC_STORE_NAME || "Sheba Mart BD",
