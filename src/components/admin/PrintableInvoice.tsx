  ...
  return (
    <div className="bg-white p-8 text-black print:p-0 w-full max-w-4xl mx-auto border print:border-none my-8 print:my-0 shadow-sm print:shadow-none font-sans">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            <div className="relative w-12 h-12 shrink-0">
              <img src="/logo.webp" alt="Sheba Mart Bd Logo" className="object-contain w-full h-full" />
            </div>
            <div className="flex flex-col justify-center px-1">
              <div className="text-2xl font-black tracking-tight leading-none text-foreground">
              ...
              <div 
                className="text-[8px] mt-1 font-medium font-sans leading-none uppercase text-foreground/75"
          ...
          <div className="text-sm text-gray-500 space-y-1">
            ...
            <p>Email: support@shebamartbd.com</p>
          </div>
        </div>
      ...
      <div className="mt-24 border-t pt-8 text-center text-xs text-gray-400">
        ...
        <p>Visit us at: www.shebamartbd.com</p>
      </div>
